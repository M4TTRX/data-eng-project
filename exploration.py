...
# # drop duplicqte values of in the plant column of df_thermal
# df_thermal.drop_duplicates(subset=['plant'], inplace=True)

# df_nuclear = pd.read_csv('dags/data/staging/nuclear_clean_datas.csv')
# # drop duplicqte values of in the plant column of df_nuclear
...
print(datetime.datetime.strptime('19990618', "%Y%m%d"))
